...
enum Errors {
    ...
    ERROR_COULDNT_OPEN_FILE                     = 4,
    // STACK_ERROR                              = 4,                  // error occured in stack

    ERROR_STACK_INVALID_FIELD_VALUES            = 5,                  // some of stack fields are invalid
    ERROR_STACK_INCORRECT_NUM_OF_ELEMS          = 6,                  // incorrect index of stack (usually happens during push or pop)
    ERROR_STACK_NEW_CAPACITY_TOO_BIG            = 7,                  // new capacity is bigger than max capacity
    ERROR_STACK_INCORRECT_CAP_KOEF              = 8,                  // incorrect capacity change koefficient
